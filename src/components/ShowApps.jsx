...
export default function ShowApps({ sources }) {
  var result = [];
  // get all sources
  for (let src of Object.values(sources)) {
    // get full html file
    ...
    // check if file is neither from 'bazaar' nor 'myket' and add error to result
    else result.push(
      <div className="bazaar">
